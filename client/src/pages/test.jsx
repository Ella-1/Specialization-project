  ...
  return (
    <div className='mt-4 bg-gray-100 -mx-8 px-8 py-8'>
      ...
      <div className='relative'>
        <div className='grid gap-2 grid-cols-[2fr_1fr] roundex-3xl overflow'>
        ...
        <button onClick={() => setShowAllPhotos(true)} className='flex gap-1 absolute bottom-2 right-2 py-2 px-4 rounded-2xl bg-white shadow shadow-gray-500'>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
