...
function PlacesForm() {
    ...
    async function savePlace() {
        const placeData = {
            title, address, addedPhotos: addedPhotos.map(ap => ap.fileName),
    ...
    useEffect(() => {
        ...
        axios.get('/places/' + id).then(response => {
            ...
            setAddedPhoto(data.photos.map(fileName => ({ fileName })));
        ...
        <div>
            ...
            <div className="">
                ...
                <form onSubmit={handleOnSubmit}>
                    ...
                    <PhotoUploader addedPhotos={addedPhotos.filter(Boolean)} onChange={setAddedPhoto} />
